...
<head>
    ...
    <title>Datenschutzerklärung | Team Sensivity</title>
...
<div class="metaportal_fn_leftnav ready">
    ...
    <div class="navbox">
            ...
            <ul class="metaportal_fn_items">
                ...
                <li>
                    <div class="item">
                        ...
                        <span class="icon">
							<img alt="" src="img/market/discord.png">
						</span>
        ...
        <div class="nav_holder">
            ...
            <!-- For JS -->
            <span class="icon">
				<img alt="" class="fn__svg" src="svg/down.svg">
			</span>
            <!-- For JS -->
            ...
            <ul>
                ...
                <li>
                    <a href="#">
                        <span class="creative_link">Pages<img alt="" class="fn__svg" src="svg/down.svg"></span>
                    </a>
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a href="#">
                                <span class="creative_link">More<img alt="" class="fn__svg" src="svg/down.svg"></span>
                            </a>
                            <ul class="sub-menu">
        ...
        <div class="info_holder">
            ...
            <div class="social_icons">
                <ul>
                    <li><a href="#"><img alt="" class="fn__svg" src="svg/social/twitter-1.svg"></a></li>
                    <li><a href="#"><img alt="" class="fn__svg" src="svg/social/facebook-1.svg"></a></li>
                    <li><a href="#"><img alt="" class="fn__svg" src="svg/social/instagram-1.svg"></a></li>
                    <li><a href="#"><img alt="" class="fn__svg" src="svg/social/pinterest-1.svg"></a></li>
                    <li><a href="#"><img alt="" class="fn__svg" src="svg/social/behance-1.svg"></a></li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="metaportal_fn_searchbox">
    <div class="container small">
        <div class="searchbox">
            ...
            <a href="#">
                <img alt="" class="fn__svg" src="svg/loupe.svg">
            </a>
        </div>
    </div>
</div>
            ...
            <ul class="metaportal_fn_items">
                <li>
                    <div class="item">
                        <a href="#"></a>
                        <span class="icon">
							<img alt="" src="img/wallet/metamask.png">
						</span>
                ...
                <li>
                    <div class="item">
                        <a href="#"></a>
                        <span class="icon">
							<img alt="" src="img/wallet/coinbase.png">
						</span>
                ...
                <li>
                    <div class="item">
                        <a href="#"></a>
                        <span class="icon">
							<img alt="" src="img/wallet/walletconnect.png">
						</span>
                ...
                <li>
                    <div class="item">
                        <a href="#"></a>
                        <span class="icon">
							<img alt="" src="img/wallet/venly.png">
						</span>
...
<div class="metaportal_fn_main">
    ...
    <header id="header">
        <div class="header">
            <div class="header_in">
                ...
                <div class="wallet">
                    <a class="metaportal_fn_button wallet_opener" href="#"><span>Connect To Wallet</span></a>
                </div>
    ...
    <div class="metaportal_fn_content">
        ...
        <div class="metaportal_fn_pagetitle">
            ...
            <div class="container small">
                <div class="pagetitle">
                    <h3 class="fn__maintitle big" data-align="center" data-text="Datenschutzerklärung">
        ...
        <div class="metaportal_fn_privacy">
            <div class="container small">
                ...
                <h3 class="fn__maintitle" data-text="1. Datenschutz auf einen Blick">1. Datenschutz auf einen Blick</h3>
                ...
                <p>Die folgenden Hinweise geben einen einfachen Überblick darüber, was mit Ihren personenbezogenen Daten
                    ...
                    persönlich identifiziert werden können. Ausführliche Informationen zum Thema entnehmen Sie unserer
                ...
                <h3 class="fn__maintitle" data-text="2. Hosting">2. Hosting</h3>
                <div class="fn_cs_divider">
                    <div class="divider">
                        <span></span>
                        <span></span>
                ...
                <h3 class="fn__maintitle" data-text="3. Allgemeine Hinweise und Pflichtinformationen">3. Allgemeine
                    Hinweise und Pflichtinformationen</h3>
                <div class="fn_cs_divider">
                    <div class="divider">
                        <span></span>
                        <span></span>
                ...
                <p>Die verantwortliche Stelle für die Datenverarbeitung auf dieser Website ist: <br><br>
                    ...
                    E-Mail: datenschutz@sensivit.team
                    <br><br>
                ...
                <p><strong>Allgemeine Hinweise zu den Rechtsgrundlagen der Datenverarbeitung auf dieser</strong></p>
                ...
                <p>Wir verwenden unter anderem Tools von Unternehmen mit Sitz in den USA oder sonstigen
                    ...
                    nicht
                    ausgeschlossen werden, dass US-Behörden (z. B. Geheimdienste) Ihre auf US-Servern befindlichen Daten
                    zu
                ...
                <p>WENN DIE DATENVERARBEITUNG AUF GRUNDLAGE VON ART. 6 ABS. 1 LIT. E ODER F DSGVO
                    ...
                    VERBINDUNG STEHT. WENN SIE WIDERSPRECHEN, WERDEN IHRE PERSONENBEZOGENEN DATEN ANSCHLIESSEND NICHT
                    MEHR ZUM ZWECKE DER DIREKTWERBUNG VERWENDET (WIDERSPRUCH
                ...
                <h3 class="fn__maintitle" data-text="4. Datenerfassung
                    auf dieser Website">4. Datenerfassung
                ...
                <p>Unsere Internetseiten verwenden so genannte „Cookies“. Cookies sind kleine Datenpakete und richten
                    ...
                    der
                    Website (z. B. Cookies zur Messung des Webpublikums) erforderlich sind (notwendige Cookies), werden
                    auf
                    ...
                    Verarbeitung ausschließlich auf Grundlage dieser Einwilligung (Art. 6 Abs. 1 lit. a DSGVO und § 25
                    Abs. 1
                ...
                <p>Der Provider der Seiten erhebt und speichert automatisch Informationen in so genannten Server-Log-
                    Dateien, die Ihr Browser automatisch an uns übermittelt. Dies sind:<br><br>
                    ...
                    dieser Daten erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Der Websitebetreiber hat
                ...
                <p>Die Speicherung der Kommentare erfolgt auf Grundlage Ihrer Einwilligung (Art. 6 Abs. 1 lit. a DSGVO).
                    ...
                    können eine von Ihnen erteilte Einwilligung jederzeit widerrufen. Dazu reicht eine formlose
                    Mitteilung per E-
                    Mail an uns. Die Rechtmäßigkeit der bereits erfolgten Datenverarbeitungsvorgänge bleibt vom Widerruf

                    unberührt..</p>

                <h3 class="fn__maintitle" data-text="5. Soziale Medien">5. Soziale Medien</h3>
                <div class="fn_cs_divider">
                    <div class="divider">
                        <span></span>
                        <span></span>
                ...
                <p>Auf dieser Website sind Funktionen des Dienstes Twitter eingebunden. Diese Funktionen werden
                    ...
                    D02
                    AX07, Irland.
                    Wenn das Social-Media-Element aktiv ist, wird eine direkte Verbindung zwischen Ihrem Endgerät und
                    dem
                    Twitter-Server hergestellt. Twitter erhält dadurch Informationen über den Besuch dieser Website
                    durch Sie.
                    ...
                    Twitter erhalten. Weitere Informationen hierzu finden Sie in der Datenschutzerklärung von Twitter
                    unter:
                    https://twitter.com/de/privacy.
                    Soweit eine Einwilligung (Consent) eingeholt wurde, erfolgt der Einsatz des o. g. Dienstes auf
                    Grundlage von
                ...
                <p>Auf dieser Website sind Funktionen des Dienstes Instagram eingebunden. Diese Funktionen werden
                    ...
                    an
                    Facebook bzw. Instagram weitergeleitet werden, sind wir und die Meta Platforms Ireland Limited, 4
                    Grand
                    ...
                    ausschließlich
                    auf die Erfassung der Daten und deren Weitergabe an Facebook bzw. Instagram. Die nach der
                    Weiterleitung
                    ...
                    (z. B. Auskunftsersuchen) hinsichtlich der bei Facebook bzw. Instagram verarbeiteten Daten können
                    Sie
                ...
                <h3 class="fn__maintitle" data-text="6. Plugins und Tools">6. Plugins und Tools</h3>
                <div class="fn_cs_divider">
                    <div class="divider">
                        <span></span>
                        <span></span>
                ...
                <p>Diese Website bindet Videos der Website YouTube ein. Betreiber der Seiten ist die Google Ireland
                    Limited
                    ...
                    entsprechende
                    Einwilligung abgefragt wurde, erfolgt die Verarbeitung ausschließlich auf Grundlage von Art. 6 Abs.
                    1 lit. a
                    DSGVO und § 25 Abs. 1 TTDSG, soweit die Einwilligung die Speicherung von Cookies oder den Zugriff
                    auf
                ...
                <p>Diese Seite nutzt zur einheitlichen Darstellung von Schriftarten und Symbolen Font Awesome. Anbieter
                    ...
                    Beim Aufruf einer Seite lädt Ihr Browser die benötigten Fonts in ihren Browsercache, um Texte,
                    Schriftarten
                    ...
                    Ihre IP-Adresse diese Website aufgerufen wurde. Die Nutzung von Font Awesome erfolgt auf Grundlage
                    von
                    Art. 6 Abs. 1 lit. f DSGVO. Wir haben ein berechtigtes Interesse an der einheitlichen Darstellung
                    des
                    Schriftbildes auf unserer Website. Sofern eine entsprechende Einwilligung abgefragt wurde, erfolgt
                    die
                    ...
                    genutzt. Weitere Informationen zu Font Awesome finden Sie und in der Datenschutzerklärung von Font
                    Awesome
                    unter:
                ...
                <p>Wir nutzen „Google reCAPTCHA“ (im Folgenden „reCAPTCHA“) auf dieser Website. Anbieter ist die Google
                    ...
                    https://policies.google.com/terms?hl=de.</p>

...
<div class="metaportal_fn_content">
    ...
    <section id="home">
        <div class="container">
            ...
            <?php
            $stmt = $pdo->query("SELECT * FROM users ORDER BY points DESC LIMIT 7;");
            $arr = array();
    ...
    <section>
        <div class="container small">
            <div class="metaportal_fn_drops">
                <ul class="grid">
                    <?php
                    $stmt = $pdo->query("SELECT * FROM users ORDER BY points DESC");
                    $i = 1;
                    while ($row = $stmt->fetch()) {
                        $color = "";
                        ...
                        <br>
                            <div class="img_holder">
                                <img src="' . $row["discord_pb"] . '?size=128" alt="" style="border-radius: 12px;" width="128px">
                                <a href="/s' . $row["website_url"] . '" class="full_link"></a>
                            </div>
